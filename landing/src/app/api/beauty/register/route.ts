  ...
  try {
    ...
    try {
      ...
      await beautyPool.query(
        `INSERT INTO "Salon" ("id", "name", "slug", "address", "phone", "email", "workingHours", "settings", "createdAt", "updatedAt")
      ...
      // Create User in beauty DB
      await beautyPool.query(
        `INSERT INTO "User" ("id", "email", "name", "password", "role", "salonId", "createdAt", "updatedAt")
         VALUES ($1, $2, $3, $4, 'OWNER', $5, NOW(), NOW())`,
        [beautyUserId, email, name, hashedPassword, salonId]
      )
      ...
      for (const cat of categories) {
        ...
        await beautyPool.query(
          `INSERT INTO "ServiceCategory" ("id", "salonId", "name", "color", "sortOrder", "isActive", "createdAt", "updatedAt")
