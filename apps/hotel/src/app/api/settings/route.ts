...
export async function GET(request: NextRequest) {
  try {
    ...
    const settings = await prisma.hotelSettings.findUnique({ where: { organizationId } })
  ...
  try {
    ...
    const settings = await prisma.hotelSettings.upsert({
      ...
      update: {
        ...
        phone: body.phone, email: body.email, website: body.website, logo: body.logo,
        taxId: body.taxId, bankName: body.bankName, bankAccount: body.bankAccount,
