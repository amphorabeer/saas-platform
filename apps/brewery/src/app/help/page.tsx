      ...
      content: (
        <div className="space-y-4 text-text-primary">
          <ol className="list-decimal list-inside space-y-2">
            <li><strong>დაამატეთ აღჭურვილობა</strong> - ტანკები, კეტლები (⚙️ აღჭურვილობა)</li>
            <li><strong>შეიყვანეთ მარაგები</strong> - ალაო, ჰოპი, საფუარი (📦 მარაგები)</li>
      ...
      content: (
        <div className="space-y-4 text-text-primary text-sm">
          ...
          <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>შეავსეთ: SKU, სახელი, კატეგორია, ერთეული, რეორდერის წერტილი</li>
            <li>დააჭირეთ "შენახვა"</li>
          </ol>
        ...
        <div className="space-y-4 text-text-primary text-sm">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-bg-tertiary rounded-lg p-3">
              ...
              <p className="text-text-muted text-xs mt-1">აირჩიეთ ტანკი → დაამატეთ გრავიტი რეგულარულად → აკონტროლეთ ტემპერატურა</p>
            </div>
            <div className="bg-bg-tertiary rounded-lg p-3">
              <h5 className="font-medium text-purple-400">3️⃣ კონდიცირება</h5>
              <p className="text-text-muted text-xs mt-1">გადაიტანეთ ტანკში → დაამატეთ FG → გამოთვალეთ ABV</p>
            </div>
            <div className="bg-bg-tertiary rounded-lg p-3">
      ...
      content: (
        <div className="space-y-4 text-text-primary text-sm">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li>ტანკების განრიგი - რომელი როდის დაკავებულია</li>
          ...
          <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>შეავსეთ: სახელი, თარიღი, ტიპი, ტანკი</li>
            <li>დააჭირეთ "შენახვა"</li>
          </ol>
        </div>
      )
        ...
        <div className="space-y-4 text-text-primary text-sm">
          ...
          <ul className="space-y-3 ml-4">
            <li className="flex items-center gap-3">
              <span>📧</span>
              <span>Email: <a href="mailto:support@brewery.geobiz.app" className="text-copper hover:underline">support@brewery.geobiz.app</a></span>
            </li>
            <li className="flex items-center gap-3">
              <span>📱</span>
              <span>ტელეფონი: +995 XXX XXX XXX</span>
            </li>
            <li className="flex items-center gap-3">
              <span>🕐</span>
