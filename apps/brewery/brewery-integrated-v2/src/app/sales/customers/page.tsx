...
const mockCustomers: Customer[] = centralCustomers.map(c => {
  ...
  return {
    ...
    phone: c.phone,
    email: c.email,
    totalOrders: customerOrders.length + Math.floor(Math.random() * 10),
    totalRevenue: totalRevenue || Math.floor(Math.random() * 50000),
