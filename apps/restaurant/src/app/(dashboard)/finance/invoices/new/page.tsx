  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-white">ახალი ინვოისი</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 rounded-2xl border border-white/10 bg-[#1E293B]/50 p-6">
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <label className={labelClass}>ინვოისის ვადა</label>
              <input
                type="date"
                value={dueDate}
        ...
        <div className="flex gap-2 pt-4">
          <Link href="/finance/invoices" className="flex-1 rounded-xl border border-white/20 py-2.5 text-center text-slate-300">გაუქმება</Link>
